...
The downloads above are rebuilt after every successful push to `combined` and
include the personal donation layer.

- [Combined source ZIP](https://github.com/mysalvium/xmrig_salvium/archive/refs/heads/combined.zip)
